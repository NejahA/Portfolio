      ...
      <div className={styles.projects}>
        ...
        <div className={styles.lcard}>
          ...
          <div className={styles.lcopy}>
            <a
              href="https://github.com/DhiaBenHass1ne/Tunist"
              target="_blank"
            ...
            <div className={styles.ldesc}>
              A web application that aims to link upcoming tourists in Tunisia
              with local guides, offering a unique and safe experience with the
              possibility of learning more about their destination through Blogs
              and renting suitable accommodation.
            </div>
          </div>
        </div>
        ...
        <div className={styles.rcard}>
          <div className={styles.rcopy}>
            <a  
              href="https://github.com/NejahA/Rewear"
              target="_blank"
              style={{ color: "black", textDecoration: "none" }}
            >
        ...
        <div className={styles.lcard}>
          ...
          <div className={styles.lcopy}>
            <a
              href="https://github.com/DhiaBenHass1ne/Fodni"
              target="_blank"
              style={{ color: "black", textDecoration: "none" }}
            >
            ...
            <div className={styles.ldesc}>
              A service marketplace that connects clients with service
              providers. It offers a streamlined platform for finding and
              offering services, ensuring quality and convenience with a
              user-friendly interface and efficient backend management.
            </div>
          </div>
        </div>
